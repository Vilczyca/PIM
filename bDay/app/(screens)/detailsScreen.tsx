...
export default function DetailsScreen() {
    ...
    const parsedId =
        typeof id === "string" ? Number(id) : Array.isArray(id) ? Number(id[0]) : undefined;

    const [mode, setMode] = useState<"view"|"edit"|"add">("view");
    const [initialData, setInitialData] = useState<PersonData|undefined>(undefined);
    ...
    useEffect(() => {
        ...
        const load = async () => {
            try {
                ...
                //mock
                const data: PersonData = { name: `Person ${parsedId}`, birthday: toDDMMYYYY("2025-11-07") };
    ...
    useLayoutEffect(() => {
        ...
        navigation.setOptions({
            title: isEditing ? "Edytuj urodziny" : "Szczegóły",
            headerRight: () => (
                <TouchableOpacity
